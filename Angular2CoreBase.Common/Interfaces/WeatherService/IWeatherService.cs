namespace Angular2CoreBase.Common.Interfaces.WeatherService
{
	...
	{
		/// <summary>
		/// Gathers weather data for use in any weather api <para />
		/// This task gathers threaded weather data from 2 webservice calls asynchronously using OpenWeather <para />
		...
		/// /// <exception cref="UriFormatException">Both the base uri and current/future uri values must be correct in the settings filesr</exception>
